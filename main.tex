...
A user must be able to simply swap instances of the block as required. To achieve this, we defined a set of inputs and outputs for each one to maintain modularity. 
